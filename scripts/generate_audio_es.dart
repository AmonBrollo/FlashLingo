...
Future<void> main() async {
  ...
  for (var fileEntity in jsonFiles) {
    ...
    for (var item in data) {
      ...
      final spanishText = card.getTranslation('spanish');

      if (spanishText.isEmpty) {
        print('⚠️  Skipping: No Spanish translation found.');
        continue;
      }

      // Use the SHARED logic to determine filename with language code
      final audioFilename = Flashcard.getAudioFilename(topicName, spanishText, 'es');
      ...
      try {
        ...
        print('\n❌ Error generating for "$spanishText": $e');
      }
    }
  }
