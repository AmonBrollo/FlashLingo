...
Future<void> main() async {
  ...
  for (var fileEntity in jsonFiles) {
    ...
    for (var item in data) {
      ...
      final hungarianText = card.getTranslation('hungarian');

      if (hungarianText.isEmpty) {
        print('⚠️  Skipping: No Hungarian translation found.');
        continue;
      }

      // Use the SHARED logic to determine filename with language code
      final audioFilename = Flashcard.getAudioFilename(topicName, hungarianText, 'hu');
      ...
      try {
        ...
        print('\n❌ Error generating for "$hungarianText": $e');
      }
    }
  }
